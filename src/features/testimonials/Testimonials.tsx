          ...
          <div className="overflow-hidden">
            <div className="h-[220px] sm:h-[200px] md:h-[180px] lg:h-[180px] flex items-stretch">
              <AnimatePresence initial={false} custom={dirRef.current} mode="popLayout">
                ...
                >
                  <blockquote className="text-gray-700 italic leading-relaxed text-lg text-center">
                    "{items[index].quote}"
                  </blockquote>
                  <figcaption className="mt-6 text-sm font-semibold text-gray-900 text-center">
                    — {items[index].name}
                  </figcaption>
                </motion.figure>
              </AnimatePresence>
          ...
          {count > 1 && (
            <>
              <button
                ...
                onClick={prev}
                className="absolute -left-3 top-1/2 -translate-y-1/2 px-3 py-2 rounded-full bg-gray-900 text-white/90 hover:text-white shadow-md transition-colors"
              >
                ‹
              </button>
              <button
                ...
                onClick={next}
                className="absolute -right-3 top-1/2 -translate-y-1/2 px-3 py-2 rounded-full bg-gray-900 text-white/90 hover:text-white shadow-md transition-colors"
              >
                ›
              </button>
